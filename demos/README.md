...
|------|--------------|-------------|
| [`chessboard/`](chessboard/) | **ArnoldC renders a chess position** — 1,092-instruction BF program reads FEN via `,` and outputs ASCII art | `bf_vm_chess.arnoldc` (23,292 lines) |
